...
**Sending the transaction from the Streamlit interface**
![Transaction sent from Streamlit interface](Images/send_transaction.png)

**Ganache account used to hire the fintech professional**
![Ganache account](Images/ganache_account.png)

**Transaction where the fintech professional was paid**
